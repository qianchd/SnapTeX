...
> **What's new in 0.8.1:** The elastic paged preview is now faster and more stable for long documents, with configurable page margins. Continuous preview remains available in settings.
