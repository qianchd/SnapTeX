...
- **Added**: Added shared top, right, bottom, and left preview margins for VS Code and Web, applied per page in paged mode and around the complete document in continuous mode.
