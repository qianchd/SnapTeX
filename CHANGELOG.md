...
- **Fixed**: Kept long `tikzpicture` environments from triggering the splitter emergency line-limit recovery, preventing large TikZ figures from being split and shown as raw source.
