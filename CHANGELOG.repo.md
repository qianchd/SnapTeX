...
- **Added**: Added one shared CSS-shorthand margin setting across VS Code and Web previews, with page-aware geometry in paged mode and document padding in continuous mode.
