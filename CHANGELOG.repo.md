...
- **Added**: Added responsive standalone Web layouts that reuse the existing pane state and manual synchronization for portrait switching while preserving the resizable dual-pane workspace in landscape.
